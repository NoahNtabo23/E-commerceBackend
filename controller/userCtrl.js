...
const forgotPasswordToken=asyncHandler(async (req, res) => {
    ...
    if(!user)throw new Error("User not found on this email")
    try{
...
const resetPassword=asyncHandler(async (req,res)=>{
    ...
    if(!user)throw new Error('Token already expired.Please try again later')
    user.password=password
...
module.exports={createUser,loginUserCtrl,getallUser,getaUser,deleteaUser,updatedUser,blockUser,unblockUser,handleRefreshToken,logout,updatePassword,forgotPasswordToken,resetPassword,loginAdmin,getWishlist,userCart,getUserCart,emptyCart,applyCoupon,createOrder,getOrders,getAllOrders,getOrderByUserId,updateOrderStatus}